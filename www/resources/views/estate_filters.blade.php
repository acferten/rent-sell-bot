...
<div class="container mt-3">
    ...
    <form method="post" enctype="multipart/form-data" id="form">
        ...
        <div class="form-group" id="price-container">
            <label class="form-group__title" for="price-start">Цена от (указывать в млн. IDR)</label>
            <input type="number" class="form-control" id="price-start" name="price_start" placeholder="500"
                   min="0">
        </div>
        <div class="form-group" id="price-container">
            <label class="form-group__title" for="price-end">Цена до (указывать в млн. IDR)</label>
